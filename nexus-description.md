...
- [Conditional Expressions Extended](https://www.nexusmods.com/skyrimspecialedition/mods/91438) has lots of dynamic effects - cold, pain, headache etc.
...
For mod authors: [How to integrate?](https://crajjjj.github.io/SexlabArousedNG/authors/compatibility/)
...
- Use [Papyrus Tweaks NG](https://www.nexusmods.com/skyrimspecialedition/mods/77779) – it can help resolve MCM registration issues by fixing script load order or timing.
- Try [MCM Menu Maid 2](https://www.nexusmods.com/skyrimspecialedition/mods/67556) – it forces stuck MCM entries to initialize.
- Wait in-game or save & reload – sometimes the MCM loads after a scene transition.

**Q: Any way to disable notifications?**

A: Disable notifications in MCM. Also consider [Notification Filter](https://www.nexusmods.com/skyrimspecialedition/mods/67925) mod.
