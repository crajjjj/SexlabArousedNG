...
### "I want my arousal to climb faster" — MCM tuning by source

Default values are tuned so a fully-clothed character idling in town hits maybe 30–40 over a day. If you want a steeper curve, the Default plugin page has every knob you need. Pick the sources you want to lean on:

**Coming from OSL Aroused?** OSL's "arousal slowly ticks up over time" maps onto SLA NG's **Timed Arousal** effect — not the Naked one. Naked here is event-based (you must *see* someone naked in LOS), so turning up its sliders won't do anything when no naked NPCs are around. If you want passive-tick behavior, raise *Timed Rate* and *Maximum Timed arousal* below.
...
- **Naked Only** (General page) — turn OFF so Bikini/Sexy/Slooty-flagged outfits also feed the Naked effect, not just fully-nude actors.
...
4. **General page:** *Use LOS* OFF (optional — makes nudity easier to trigger).
...
### "I'm coming from OSL Aroused and nothing is happening"
